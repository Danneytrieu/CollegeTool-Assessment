...
export default function StudyPage() {
  ...
  const renderContent = () => {
    ...
    switch (mode) {
      ...
      case "quiz":
        return <Quiz questions={questions} clearPDF={clearPDF} title={title || "Quiz"} />;
      case "match":
  ...
  return (
    <div className="min-h-screen p-8">
      <h1 className="text-3xl font-bold text-center mb-8">{title || "Study Session"}</h1>
      
      {questions.length > 0 ? (
        <>
          <ModeSelector onSelectMode={setMode} selectedMode={mode} />
